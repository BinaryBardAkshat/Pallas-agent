...
AUX_MODEL_ANTHROPIC = "claude-3-5-haiku-latest"
AUX_MODEL_GOOGLE = "gemini-2.0-flash"
AUX_MODEL_OPENAI = "gpt-4o-mini"
AUX_MODEL_OPENROUTER = "anthropic/claude-3.5-haiku"
AUX_MODEL_OLLAMA = "llama3.2:3b"

AUX_MODELS = {
    PROVIDER_ANTHROPIC: AUX_MODEL_ANTHROPIC,
    PROVIDER_GOOGLE: AUX_MODEL_GOOGLE,
    PROVIDER_OPENAI: AUX_MODEL_OPENAI,
    PROVIDER_OPENROUTER: AUX_MODEL_OPENROUTER,
    PROVIDER_OLLAMA: AUX_MODEL_OLLAMA,
}
